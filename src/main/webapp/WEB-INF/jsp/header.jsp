...
<link
	href="${pageContext.request.contextPath}/assets/css/sticky-footer-navbar.css"
	rel="stylesheet">
...
<!-- jquery ui -->
<script
	src="${pageContext.request.contextPath}/assets/js/jqueryUI/jquery-ui.min.js"></script>
